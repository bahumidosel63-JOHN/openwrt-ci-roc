...
sed -i 's/opp-microvolt = <937500>;/opp-microvolt = <947500>;/' target/linux/qualcommax/patches-6.12/0038-v6.16-arm64-dts-qcom-ipq6018-add-1.5GHz-CPU-Frequency.patch
